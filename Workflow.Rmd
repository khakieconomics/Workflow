...
library(BSEcon); library(ggthemes)
...
will typically be decided by the nature (and constraints) of our data. Below we list the sorts of 
things we need to check (typically by data visualization) in our data to help us choose the right 
distributions, as well as describing some commonly-used distributions. 
...
probability of observing values of a random variable within a range. For example, take a standard normal distribution 
