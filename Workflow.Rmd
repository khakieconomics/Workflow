...
of these function need to have a neat analytical form. When we can represent $p()$ with an algebraic 
expression with a fixed number of parameters, then we say that $p()$ is a *parametric* distribution function. 
If we know the distribution of a random variable with certainty, then we can also make probabilistic 
statements about the random variable falling within a set of values.
