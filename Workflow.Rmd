...
on the assumption that the proposed _generative distribution_ gave rise to the observed data. The. This is most easily motivated with an example. 
...
in $\theta$---it does not integrate to 1. This is a common source of confustion, firstly because it looks
...
samples. In this case, before we did the analysis that the default rate was 2%. This is what we might call 
...
us the mode of the likelihood, it gives us the maximum likelihood estimator (MLE). The mode needn't be 
